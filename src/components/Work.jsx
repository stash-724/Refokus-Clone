...
export default function Work() {
  var images = [
    ...
    { url: "https://assets-global.website-files.com/6334198f239547d0f9cd84b3/634ef0af108a465002975acd_Showcase%20Websites%20(1).png", top: "65%", left: "55%", isActive: true },
  ];
  return (
      ...
      <div className='relative max-w-screen-xl mx-auto text-center'>
        ...
        <div className='top-0 h-full w-full absolute'>
          {images.map((elem, index)=>{
            return elem.isActive && (<img className='w-60 rounded-lg absolute -translate-x-[50%] -translate-y-[50%]' src={elem.url} style={{top : elem.top , left : elem.left}} alt="" />)
          })}
        </div>
      </div>
